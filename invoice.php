...
<!--        </div>-->
<!--        <div class="col-md-6 text-bg-light">-->
<!--            --><?php //= $cusNameFirst . " " . $cusNameSecond ?>
<!--        </div>-->
<!--        <div class="col-md-6 text-primary">-->
<!--            Address-->
<!--        </div>-->
...
<!--    <div class="row">-->
<!--        <div class="col-lg-3">Product 1</div>-->
<!--        <div class="col-lg-3">$--><?php //= $prod1ItemCost ?><!--</div>-->
<!--        <div class="col-lg-3">--><?php //= $prod1Quantity ?><!--</div>-->
<!--        <div class="col-lg-3">$--><?php //= $prod1SubTotal ?><!--</div>-->
<!--    </div>-->
<!--    <div class="row">-->
<!--        <div class="col-lg-3">Product 2</div>-->
<!--        <div class="col-lg-3">$--><?php //= $prod2ItemCost ?><!--</div>-->
<!--        <div class="col-lg-3">--><?php //= $prod2Quantity ?><!--</div>-->
<!--        <div class="col-lg-3">$--><?php //= $prod2SubTotal ?><!--</div>-->
<!--    </div>-->
<!--    <div class="row">-->
<!--        <div class="col-lg-3">Product 3</div>-->
<!--        <div class="col-lg-3">$--><?php //= $prod3ItemCost ?><!--</div>-->
<!--        <div class="col-lg-3">--><?php //= $prod3Quantity ?><!--</div>-->
<!--        <div class="col-lg-3">$--><?php //= $prod3SubTotal ?><!--</div>-->
<!--    </div>-->
<!--    <div class="row">-->
<!--        <div class="col-lg-3">Product 4</d-->
<!---->
<!---->
<!--<!--Customer Details-->-->
<!--<h1 class="text-primary">Invoice</h1>-->
